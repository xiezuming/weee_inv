<script  type="text/javascript" > 
	...
	function LoadCart()
	{
		var html="<thead><tr><th style='width: 100'>Global Item Id</th>";
		html+="<th style='width: 500'>Title</th><th style='width: 100'>Price($)</th>";
		html+="<th style='width: 100'>Available Quantity</th><th style='width: 100'>Purchase Quantity</th>";
...
<h3>Customer Name:  <input id='iptCustomer' value='N/A'/></h3>
