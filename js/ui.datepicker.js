...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		clearText: 'Clear', // Display text for clear link 2009-07-12 ���μ���
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		//showClearButton:false //2009-07-10 ���μ���
	};
...
/*
	//2009-07-13 ���μ��� ʵ�־ۼ�ʧȥ����֤���ڸ�ʽ
	_doblur:function(event)
	{
		var inst = $.datepicker._getInst(event.target);

		if(inst.input[0].value.length==0)//����Ϊ��
			return;
		...
		{
			//alert("�����ʱ���ʽ,�밴��ʽ��д\n ��: 2014-11-11");
			var today=new Date();//����Ϊ��ǰ����
			alert(today.getYear());
			inst.input[0].value=(today.getYear()+1900)+"-"+(today.getMonth()+1)+"-"+today.getDate();
			inst.input[0].focus();
			return;
		}
